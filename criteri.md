...
> L'agente lo legge ad ogni ricerca automaticamente.
...
- Box auto o posto auto incluso (+0.5)
- Luminoso / doppia esposizione (+0.5)
- Classe energetica A o B (+0.5)
- Portiere/portineria (+0.3)
- Nuova costruzione o ristrutturazione recente (+0.5)
